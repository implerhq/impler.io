...
export const CONSTANTS = {
  ...
  PAYMENT_INTENT_SUCCCESS_CODE: 'succeeded',
...
export const API_KEYS = {
  ...
  PAYMENT_INTENT_FAILED: 'PAYMENT_INTEND_FAILED',

  ADD_PAYMENT_METHOD: 'ADD_PAYMENT_METHOD',
  UPDATE_DEFAULT_SUBSCRIPTION_PAYMENT_METHOD: 'UPDATE_DEFAULT_SUBSCRIPTION_PAYMENT_METHOD',
