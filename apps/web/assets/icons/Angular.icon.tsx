...
export const AngularIcon = ({ size = 'lg', color = '#fff' }: IconType) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={IconSizes[size]} height={IconSizes[size]} fill="none">
    <g clipPath="url(#a)" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      />
      <path
        d="M9 15.5L12 7.5L15 15.5"
        stroke="#CCCCCC"
        stroke-width="1.5"
        stroke-linecap="round"
        stroke-linejoin="round"
      />
      <path d="M10 13.5H14" stroke="#CCCCCC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </g>
    <defs>
