...
export function GridIcon(props: IIcon) {
  return (
    <svg
      ...
      style={props?.styles}
    >
      <g clip-path="url(#clip0_4259_5403)">
        <path
        ...
        />
        <path d="M2.625 9.25H18.375" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        <path d="M8.75 3.125V18.875" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
      </g>
      <defs>
